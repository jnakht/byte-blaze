            ...
            <div className="hero bg-base-200 min-h-[calc(100vh-120px)]  relative">
                <div className="hero-content text-center -mt-18">
                    <div className="max-w-lg">
                        <h1 className="text-5xl font-bold">Welcome to <span className="text-4xl font-extrabold bg-gradient-to-r from-primary via-blue-500 to-secondary text-transparent bg-clip-text bg-300% animate-gradient">ByteBlaze</span></h1>
                        <p className="py-6">
